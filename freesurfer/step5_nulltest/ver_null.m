...
for iSite = 1:length(datasets)
    ...
    for iDiag = 1:nDiag
        ...
        for iFile = 1:length(filesDiag)
            ...
            load(fullfile(filesDiag(iFile).folder,filesDiag(iFile).name),'zmapSurrs','sigmapSurrs_HC_P','sigmapSurrs_P_HC','sigFdrmapSurrs_HC_P','sigFdrmapSurrs_P_HC','sigClustermapSurrs_HC_P','sigClustermapSurrs_P_HC');
...
sigClustermapSurrsHC_PFull(:,s.mask==1) = sigClustermapSurrs_HC_P';
  ...
  sigClustermapSurrsHC_PVer(:,mapStartIn:mapEndIn) = sigClustermapSurrsHC_PFull';
        ...
        save(fullfile(datadir,datasets(iSite).name,['verThresMap_',namepart(1:end-6),'.mat']), "sigmapSurrsHC_PVer", "sigmapSurrsP_HCVer","sigFdrmapSurrsHC_PVer","sigFdrmapSurrsP_HCVer","sigClustermapSurrsHC_PVer","sigClustermapSurrsP_HCVer");


        clear zmapSurrsVer  sigmapSurrsHC_PFull  sigmapSurrsP_HCFull sigFdrmapSurrsHC_PFull sigFdrmapSurrsP_HCFull sigClustermapSurrsHC_PFull sigClustermapSurrsP_HCFull
        clear sigmapSurrsHC_PVer sigmapSurrsP_HCVer sigFdrmapSurrsHC_PVer sigFdrmapSurrsP_HCVer sigClustermapSurrsHC_PVer sigClustermapSurrsP_HCVer
    end
end