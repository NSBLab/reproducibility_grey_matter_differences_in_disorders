...
load('output/corr_zmap_subdivide_2sitegroup_samesize.mat', 'meanCorThres','varCorThres');
meanCor = meanCorThres;
varCor = varCorThres;
...
%%
savefig(fig,['output/figure_corr_zmap_subdivide_2sitegroup_samesize.fig']);
set(fig, 'PaperPositionMode', 'auto')
print(fig, '-djpeg', '-r1200', 'output/figure_corr_zmap_subdivide_2sitegroup_samesize.jpg')