...
matlab -nodisplay -r "addpath('$script_DIR');  run_resample_samesite_func($smoothKernel,$nGroup,$iResample,$randomNumber)"
...
outdir=/scratch/kg98/trangc/VBM/data/derivatives/freesurfer/s10COMBAT/resample_samesite/nGroup_$nGroup
cd $outdir
