...
%%
savefig(fig,['output/figure_corr_zmap_subdivide_2sitegroup_samesize_combine4.fig']);
set(fig, 'PaperPositionMode', 'auto')
print(fig, '-djpeg', '-r1200', 'output/figure_corr_zmap_subdivide_2sitegroup_samesize_combine4.jpg')