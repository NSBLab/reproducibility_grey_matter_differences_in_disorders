...
switch parc
    ...
    case 'DK'
        ...
        corDiag = corSigDK;
        corDiagNull = corsigmapSurrsDKAll;
        zmap = map.sigmapDK;
        % DK atlas
    ...
    case 'SF100'
        corDiag = corSigSF100;
        corDiagNull = corsigmapSurrsSF100All;
    ...
    case 'SF500'
        corDiag = corSigSF500;
        corDiagNull = corsigmapSurrsSF500All;
        ...
        [lia locb] = ismember(tempLabel, colorcode);
    case 'SF1000'
        corDiag = corSigSF1000;
        corDiagNull = corsigmapSurrsSF1000All;
...
%%
savefig(fig,['output/figure_corr_zmap_parcel_',parc,'_sigmap.fig']);
set(fig, 'PaperPositionMode', 'auto')
print(fig, '-djpeg', '-r1200',[ 'output/figure_corr_zmap_parcel_',parc,'_sigmap.jpg'])
