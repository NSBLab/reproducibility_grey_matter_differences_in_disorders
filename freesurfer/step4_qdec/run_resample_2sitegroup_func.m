...
function run_resample_2sitegroup_func(diag,smoothKernel,hemis,iSubdivide,randomSubdivide,sampleSize,iResample,randomSample)
...
subdivideDir = fullfile('/scratch','kg98','trangc','VBM','data', 'derivatives', 'freesurfer',['s',num2str(smoothKernel),'noCOMBAT'],['diag',num2str(diag)],hemis, 'resample_2sitegroup',['iSubdivide_',num2str(iSubdivide),'_seed2group_',num2str(randomSubdivide)]);
