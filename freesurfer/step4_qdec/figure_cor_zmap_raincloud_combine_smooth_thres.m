...
for iPara = 1:nPara
    ...
    load(['output/corr_zmap_combat',num2str(iCOMBAT),'_smooth',num2str(smoothKernel),'_',hemi,'_all.mat'], 'map','corDiag','corSigHC_P', 'corSigP_HC','repSigHC_P','repSigP_HC',...
        'siteList')
...
a26 = annotation(fig, 'textbox', [0.01, 0.27, 0.2, 0.02], 'string', 'd|Controls < cases', 'edgecolor', 'none', ...
    'FontName',font_name,'FontSize',font_size,  'horizontalalignment', 'left');
%%
savefig(fig,['output/figure_corr_zmap_combat',char(num2str(iCOMBAT)),'_smooth',num2str(smoothKernel),'_smooth_thres_combine.fig']);
set(fig, 'PaperPositionMode', 'auto')
print(fig, '-djpeg', '-r1200', ['output/figure_corr_zmap_combat',char(num2str(iCOMBAT)),'_smooth',num2str(smoothKernel),'_smooth_thres_combine.jpg'])
