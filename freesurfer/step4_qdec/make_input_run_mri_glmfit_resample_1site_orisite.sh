...
outdir=/scratch/kg98/trangc/VBM/data/derivatives/freesurfer/s${smoothKernel}noCOMBAT/diag${diag}/${hemis}/resample_1site
cd $outdir
		
covariance1=sex
covariance2=age

export sitefile=orisite.txt
	...
	do
		...
		#make list input
		echo "$datadir/${parts[4]}/derivatives/freesurfer/${parts[0]}/surf/${hemis}.${measure}.fwhm${smoothKernel}.fsaverage.mgh" >> $inputfile
