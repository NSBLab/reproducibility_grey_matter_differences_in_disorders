...
do
	...
	do
		...
		for iarraySubdivide in ${arraySubdivide[@]}; do
			...
			if [ -f $outdir/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}_group1.txt ] & [ -f $outdir/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}_group2.txt ] & [ -f $outdir/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}_group1_SF_combat/${hemis}.${measure}.fwhm0.fsaverage.mat ] # & [ ! -f $outdir/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}/iSubdivide_${iSubdivide}_seed2group_${randomSubdivide}_group1_SF_combat/${hemis}.${measure}.fwhm0_glm.fsaverage.mat ]; 
			then 
				echo $iSubdivide
				sbatch --job-name=glm_${diag}_${groupsize}_${iSubdivide} ${script_DIR}/glm_parc_resample_2sitegroup.sh

				#sh ${script_DIR}/glm_resample_2sitegroup.sh
			fi
