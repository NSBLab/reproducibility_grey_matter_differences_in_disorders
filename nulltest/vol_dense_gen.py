...
if os.path.isdir(full_path):  # Check if it is a directory
    ...
    output_folder = '/scratch2/kg98/trangc/VBM/data/nulltest/surrogateVBM/s' + smoothkernel + 'COMBAT/' + condition + '/' + site
    ...
    output_filename = output_folder + '/' + 'spmT_0001_surrogate_' + ranseed + '.nii.gz'
