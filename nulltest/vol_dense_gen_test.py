...
kwargs['ns']) + '_' + str(kwargs['knn']) + '_' + str(kwargs['pv']) + "_smooth" + smoothkernel +"_index.txt"
...
output2_filename = "/home/trangc/kg98/trangc/VBM/code/nulltest/pythonProject/test_dense_vol_sur_vario"+str(kwargs['ns']) + '_'+ str(kwargs['knn'])+'_'+str(kwargs['pv'])+ "_smooth" + smoothkernel +"_index.txt"
...
output3_filename = "/home/trangc/kg98/trangc/VBM/code/nulltest/pythonProject/test_dense_vol_map" + str(
    kwargs['ns']) + '_' + str(kwargs['knn']) + '_' + str(kwargs['pv']) + "_smooth" + smoothkernel + "_index.nii.gz"
