...
load(['output/corr_tmap_combat',num2str(iCOMBAT),'_smooth',num2str(smoothKernel),'.mat'], 'corThresFWE1', 'corThresFWE2','repThresFWE1','repThresFWE2','siteList','t1All','thresmapFWE1','thresmapFWE2');
...
switch vari
    case 'corHC_P'
        corDiag = corThresFWE1;
        corDiagNull = cortmapBrainsmashSurrsVerAll;
        thresmap = thresmapFWE1;
    case 'corP_HC'
        corDiag = corThresFWE2;
        corDiagNull = cortmapBrainsmashSurrsVerAll;
        thresmap = thresmapFWE2;
    case 'repHC_P'
        corDiag = repThresFWE1;
        corDiagNull = cortmapBrainsmashSurrsVerAll;
        thresmap = thresmapFWE1;
    case 'repP_HC'
        corDiag = repThresFWE2;
        corDiagNull = cortmapBrainsmashSurrsVerAll;
        thresmap = thresmapFWE2;
    otherwise
        error('not valid');
...
switch vari
    case 'corHC_P'
        savefig(fig,['output/figure_corr_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'HC_P.fig']);
        set(fig, 'PaperPositionMode', 'auto')
        print(fig, '-djpeg', '-r1200', ['output/figure_corr_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'HC_P.jpg'])
    case 'corP_HC'
        savefig(fig,['output/figure_corr_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'P_HC.fig']);
        set(fig, 'PaperPositionMode', 'auto')
        print(fig, '-djpeg', '-r1200', ['output/figure_corr_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'P_HC.jpg'])
    case 'repHC_P'
        savefig(fig,['output/figure_rep_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'HC_P.fig']);
        set(fig, 'PaperPositionMode', 'auto')
        print(fig, '-djpeg', '-r1200', ['output/figure_rep_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'HC_P.jpg'])
    case 'repP_HC'
        savefig(fig,['output/figure_rep_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'P_HC.fig']);
        set(fig, 'PaperPositionMode', 'auto')
        print(fig, '-djpeg', '-r1200', ['output/figure_rep_tmap_thres_FWE_combat',char(num2str(iCOMBAT)),'P_HC.jpg'])
    otherwise
        error('not valid');
end
