function segmentation_roi_job(fname) 
%-----------------------------------------------------------------------
% Job saved on 18-Mar-2024 13:15:04 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.cat.estwrite.data = {[fname ',1']};
matlabbatch{1}.spm.tools.cat.estwrite.data_wmh = {''};
matlabbatch{1}.spm.tools.cat.estwrite.nproc = 6;
matlabbatch{1}.spm.tools.cat.estwrite.useprior = '';
matlabbatch{1}.spm.tools.cat.estwrite.opts.tpm = {'/fs03/kg98/trangc/toolbox/spm12/tpm/TPM.nii'};
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.shooting.shootingtpm = {'/fs03/kg98/trangc/toolbox/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
...
matlabbatch{1}.spm.tools.cat.estwrite.output.ROImenu.atlases.ownatlas = {
                                                                         '/fs03/kg98/trangc/toolbox/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/Tian_Subcortex_S4_7T.nii,1'
                                                                         '/fs03/kg98/trangc/toolbox/spm12/toolbox/cat12/templates_MNI152NLin2009cAsym/Schaefer2018_600Parcels_17Networks_order.nii,1'
                                                                         };
