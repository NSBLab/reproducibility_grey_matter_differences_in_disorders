...
imageFile.format = cellstr(imageFile.image_file_format);
% imageFile.site = cellstr(num2str(ismember(imageFile.format,{'parrec','PARREC'})));

imageFile.site = cellstr(imageFile.scanner_type_pd);
...
metadata.site_string(ismember(metadata.site_string,'Signa HDxt')) = {'Signa_HDxt'};
