...
for iSub = 1:length(useFolder)
            ...
            copyfile(['/scratch/kg98/Data_Trang/SCZ_transdiagnostic/',char(useFolder(iSub)),'/anat/',char(useFolder(iSub)),'_run-01_T1w.nii.gz'],...
                ['/projects/kg98/trangc/VBM/data/', study,'/',char(useFolder(iSub)),'/anat/',char(useFolder(iSub)),'_T1w.nii.gz'  ]);
           copyfile(['/scratch/kg98/Data_Trang/SCZ_transdiagnostic/',char(useFolder(iSub)),'/anat/',char(useFolder(iSub)),'_run-01_T1w.json'],...
                ['/projects/kg98/trangc/VBM/data/', study,'/',char(useFolder(iSub)),'/anat/',char(useFolder(iSub)),'_T1w.json'  ]);
