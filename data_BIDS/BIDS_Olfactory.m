...
imageFile.src_subject_id = cellstr(arrayfun(@(x) num2str(sprintf('%04d',x(3:end))), imageTable.src_subject_id(2:end,:), 'UniformOutput', false));
...
siteFile.src_subject_id = cellstr(arrayfun(@(x) num2str(sprintf('%04d',x(3:end))), siteTable.src_subject_id, 'UniformOutput', false));
