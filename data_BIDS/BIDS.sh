...
while read SUBJECTID; do
	...
	#	echo ${SUBJECTID}
		...
		#mv /home/trangc/kg98/trangc/VBM/data/${dataset}/sub-${SUBJECTID:2:5}/anat/${SUBJECTID:0:-3} /home/trangc/kg98/trangc/VBM/data/${dataset}/sub-${SUBJECTID:2:5}/anat/sub-${SUBJECTID:2:5}_T1w.nii
