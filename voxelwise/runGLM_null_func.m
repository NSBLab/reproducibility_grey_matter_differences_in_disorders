function runGLM_null_func(datasets,isses,smoothKernel,maskDiag,iNull, randomNumber)
% This script
...
outDir = ['/scratch2/kg98/trangc/VBM/data/derivatives/s', num2str(smoothKernel),'null/' ,num2str(iNull),'/'];
if ~exist(outDir,'dir')
    mkdir(outDir);
end
...
for s = 1:numSite
 ...
 delete(fullfile(newSubFolder,'*'));
        ...
        factorial_design_ttest_job(newSubFolder, hcNullCell, patNullCell, age, sex, tiv, maskDir)
