...
for d=1:length(datasets)
    ...
    % Load in metadata
    metadataFilename = ['/home/trangc/kg98_scratch/Ashlea/parcellation_v2/subjlists/', dataset, '_dems.csv'];
    ...
    for i=1:size(metadata,1)
        subj_id = metadata.subj_id{i}
        subNiftiSmooth = [inDir,dataset,'/',subj_id,'/anat/s8mwp1',subj_id, '_T1w.nii'];
