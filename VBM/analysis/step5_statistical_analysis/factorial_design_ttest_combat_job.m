...
%-----------------------------------------------------------------------
function factorial_design_ttest_combat_job(outDir, hcCell, patCell, age, sex, tiv, maskFolder)
...
% 	matlabbatch{1}.spm.stats.factorial_design.masking.tm.tma.athresh = 0;
