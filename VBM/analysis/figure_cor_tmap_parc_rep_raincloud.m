...
for iDiag = 1:nDiag
    ...
    colRight = [min(colMinNoDiagonal(1), rowMinNoDiagonal(1)) max(colMinNoDiagonal(1), rowMinNoDiagonal(1))];
...
%%
savefig(fig,['output/figure_corr_tmap_parc_',char(num2str(nParc)),'_rep_combat.fig']);
set(fig, 'PaperPositionMode', 'auto')
print(fig, '-djpeg', '-r1200', ['output/figure_corr_tmap_parc_',char(num2str(nParc)),'_rep_combat.jpg'])
