...
brain_map = '/projects/kg98/trangc/VBM/data/derivatives/roi' + '/' +diag + '/' + dataset + '/' + nParc + '_parcCon_thresMap.txt'

gen = Sampled(x=brain_map, D=distance_files['D'], index=distance_files['index'], **kwargs)
surrogate_maps = gen(n=100)

output_filename = '/projects/kg98/trangc/VBM/data/derivatives/roi' + '/' +diag + '/' + dataset + '/' + nParc + '_parcCon_thresMap_null.txt'
