...
for iDiag = 1:nDiag
 % Compute variance related to treatment and site correlation
    [varTable{iDiag} nSite{iDiag}]= cor_var_treatment(metadata, ...
...
warning('off','last')
save('output/confound_treatment.mat','varTable','nSite')