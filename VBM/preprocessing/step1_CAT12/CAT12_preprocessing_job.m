function CAT12_preprocessing_job(fname) 
%-----------------------------------------------------------------------
% Job saved on 18-Mar-2023 07:25:23 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{1}.spm.tools.cat.estwrite.opts.tpm = {'/usr/local/spm12/matlab2021a.r7771-v1/tpm/TPM.nii'};
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.shooting.shootingtpm = {'/usr/local/spm12/matlab2021a.r7771-v1/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
