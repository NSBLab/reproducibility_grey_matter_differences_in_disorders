...
function run_divide_2sitegroup_nosplitsite_func(diag,smoothKernel,hemis,iSubdivide,randomSubdivide)
...
outDir = fullfile('/scratch','kg98','trangc','VBM','data', 'derivatives', 'freesurfer',['s',num2str(smoothKernel),'noCOMBAT'],['diag',num2str(diag)],hemis, 'resample_2sitegroup_nosplitsite',['iSubdivide_',num2str(iSubdivide),'_seed2group_',num2str(randomSubdivide)]);
if ~exist(outDir, 'dir')
    mkdir(outDir);
end
