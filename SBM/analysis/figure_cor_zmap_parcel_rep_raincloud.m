...
% mean and range
meanCor =  cellfun(@(x) mean(x), corToPlot, 'UniformOutput',false);
...
%%
savefig(fig,['output/figure_corr_zmap_parcel_',parc,'_repmap.fig']);
set(fig, 'PaperPositionMode', 'auto')
print(fig, '-djpeg', '-r1200',[ 'output/figure_corr_zmap_parcel_',parc,'_repmap.jpg'])
