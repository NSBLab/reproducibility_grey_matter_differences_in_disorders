...
function run_resample_1site_func(diag,smoothKernel,hemis,sampleSize,iResample,randomSample)
...
subdivideDir = fullfile('/scratch','kg98','trangc','VBM','data', 'derivatives', 'freesurfer',['s',num2str(smoothKernel),'noCOMBAT'],['diag',num2str(diag)],hemis, 'resample_1site');
