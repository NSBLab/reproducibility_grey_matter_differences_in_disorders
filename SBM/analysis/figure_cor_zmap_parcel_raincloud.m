...
switch parc
    ...
    case 'SF100cormap'
        corDiag = corDiagSF100;
        corDiagNull = corzmapSurrsSF100All;
        zmap = map.zmapSF100;
        % Schaefer atlas
        ...
        [lia locb] = ismember(tempLabel, colorcode);
    case 'SF500cormap'
        corDiag = corDiagSF500;
        corDiagNull = corzmapSurrsSF500All;
        zmap = map.zmapSF500;
        ...
        [lia locb] = ismember(tempLabel, colorcode);
    case 'SF1000cormap'
        corDiag = corDiagSF1000;
        corDiagNull = corzmapSurrsSF1000All;
        zmap = map.zmapSF1000;
...
%%
savefig(fig,['output/figure_corr_zmap_parcel_',parc,'_corzmap.fig']);
set(fig, 'PaperPositionMode', 'auto')
print(fig, '-djpeg', '-r1200',[ 'output/figure_corr_zmap_parcel_',parc,'_corzmap.jpg'])
