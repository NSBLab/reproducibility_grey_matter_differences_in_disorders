...
matlab -nodisplay -r "addpath('$script_DIR');  run_resample_func($smoothKernel,$sampleSize,$iResample,$randomNumber)"
...
outdir=/scratch/kg98/trangc/VBM/data/derivatives/freesurfer/s10COMBAT/resample/sampleSize_$sampleSize
cd $outdir
