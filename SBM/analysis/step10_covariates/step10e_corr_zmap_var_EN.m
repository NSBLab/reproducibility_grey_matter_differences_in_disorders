function step10e_corr_zmap_var_EN(config, hemi, iter, type)
% STEP10E: Euler number (scan quality) mean/variance between sites vs z-map correlation.
% Usage: step10e_corr_zmap_var_EN(config [, hemi, iter, type])
% Prereq: step9a. Writes: confound_EN.mat under results/SBM/analysis/output/.
...
warning('off', 'last');
save(fullfile(output_dir, 'confound_EN.mat'), 'varTable', 'meanEN', 'varEN', 'nSite');
end
