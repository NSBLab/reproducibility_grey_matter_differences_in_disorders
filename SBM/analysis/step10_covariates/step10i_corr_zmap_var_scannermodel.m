function step10i_corr_zmap_var_scannermodel(config, hemi, iter, type)
% STEP10I: Scanner model similarity between sites vs z-map correlation.
% Usage: step10i_corr_zmap_var_scannermodel(config [, hemi, iter, type])
...
warning('off', 'last');
save(fullfile(output_dir, 'confound_scannerModel.mat'), 'varTable', 'modelSim', 'nSite');
end
