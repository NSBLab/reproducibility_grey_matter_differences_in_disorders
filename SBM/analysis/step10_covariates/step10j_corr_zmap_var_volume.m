function step10j_corr_zmap_var_volume(config, hemi, iter, type)
% STEP10J: Voxel volume ratio between sites vs z-map correlation.
% Usage: step10j_corr_zmap_var_volume(config [, hemi, iter, type])
...
warning('off', 'last');
save(fullfile(output_dir, 'confound_vol.mat'), 'varTable', 'volRatio', 'nSite');
end
