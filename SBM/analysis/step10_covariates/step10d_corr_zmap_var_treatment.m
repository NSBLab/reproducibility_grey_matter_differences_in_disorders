function step10d_corr_zmap_var_treatment(config, hemi, iter, type)
% STEP10D: Medication/treatment rate between sites vs z-map correlation.
% Usage: step10d_corr_zmap_var_treatment(config [, hemi, iter, type])
% Prereq: step9a. Writes: confound_treatment.mat under results/SBM/analysis/output/.
...
warning('off', 'last');
save(fullfile(output_dir, 'confound_treatment.mat'), 'varTable', 'medRatio', 'nSite');
end
