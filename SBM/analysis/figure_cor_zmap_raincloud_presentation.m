...
load(['output/corr_zmap_combat',num2str(iCOMBAT),'_smooth',num2str(smoothKernel),'_all.mat'], 'map','corDiag', 'corSig','siteList')
...
% %%
% savefig(fig,['output/figure_corr_zmap_combat_all.fig']);
% set(fig, 'PaperPositionMode', 'auto')
% print(fig, '-djpeg', '-r1200', 'output/figure_corr_zmap_combat.jpg')
