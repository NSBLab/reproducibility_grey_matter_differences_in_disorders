...
metadata.site = cellstr(repmat('49',size(indexHighQRinUseFolder)));
...
imageTable(ismember(cellstr(imageTable.oasis_id),{testsub1.subj_id{1}(5:end),testsub2.subj_id{1}(5:end)}),:)
